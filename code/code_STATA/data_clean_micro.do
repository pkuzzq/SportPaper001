...
******************************************************************************
/*
This do-file cleans the micro-level data used in the paper.

Input data files:
1.The raw data of a 1% sample of the 1990 Chinese Population census
2.The raw data of a 1% sample of the 1982 Chinese Population census
3.The raw data of a 1% sample of the 2000 Chinese Population census
4.The raw data of a 0.1% sample of the 2010 Chinese Population census
5.The raw data of the 2010 wave of China Family Panel Studies
6.Our county level data including SDY information (county_data.dta)
